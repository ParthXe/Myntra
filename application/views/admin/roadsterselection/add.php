            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php echo form_open("admin/roadsterSelection/add/$type", 'class="form-add-edit" role="form" autocomplete="off" enctype="multipart/form-data"') ; ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="collectionHeadingTxt" name="collectionHeadingTxt" value="" required/>
						</div>
						<div class="form-group">
							<label for="collectionTxt">Collection Text:</label>
							<textarea class="form-control" id="collectionTxt" name="collectionTxt" value="" required/></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="catalogueHeadingTxt" name="catalogueHeadingTxt" value="" required/>
						</div>
						<div class="form-group">
							<label for="catalogueTxt">Catalogue Text:</label>
							<textarea class="form-control" id="catalogueTxt" name="catalogueTxt" value="" required/></textarea>
						</div>
						<div class="form-group">
