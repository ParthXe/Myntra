        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php  $path = base_url()."myntra/section_products/pro_shirts/signature_video/".$signature['video']; ?>
           <div class="form-group">
              ...
              <?php if($signature_images = $signature['thumbnail']){
               echo '<img src="'.base_url().'myntra/section_products/pro_shirts/signature_video/'.$signature_images.'" width="150px"><a href="#" onclick="imageRemove('."'".$signature['video']."'".','."'".$signature['thumbnail']."'".','."'".$signature['id']."'".','."'shirt'".')"><i class="fa fa-times" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;'; 
                }
                else
                {
               ...
               ?>
						...
						<div class="form-group">
                            ...
                            </video> <?php echo '<a href="#" onclick="imageRemove('."'".$signature['video']."'".','."'".$signature['thumbnail']."'".','."'".$signature['id']."'".','."'shirt'".')"><i class="fa fa-times" aria-hidden="true"></i></a>' ?>
                            <?php } else { ?>
                            No videos
                           <?php } ?>
						</div>			
