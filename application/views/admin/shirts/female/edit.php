...
<!-- 						<div class="form-group">
						...
						<div class="form-group">
							...
							<?php
							$path = base_url()."upload/shirts/female/vintage_video/".$shirt_female['vintage_video'];  if(!empty($shirt_female['vintage_video'])) {?> 
							<video width="200">
                            <source src="<?php echo isset($path) ? $path : 'NA';?>" type="video/mp4">
                            </video> <?php echo '<a href="#" onclick="imageRemove('."'".$shirt_female['vintage_video']."'".','."'".$shirt_female['id']."'".','."'vintage_video'".')"><i class="fa fa-times" aria-hidden="true"></i></a>' ?>
                            <?php } else { ?>
                            No videos
                           <?php } ?>
						</div>
