...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Shirt Products List<small><a href="<?php echo base_url("admin/shirts/female_add"); ?>">Add Shirt Products</a></small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Shirt Female Products List</h3>
                  <div class="box-tools">
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="table">
                    ...
                    <?php if (count($shirt_female) > 0 ){ ?>
                    <?php foreach($shirt_female as $products_info) : ?>
                        <tr>
                           <td><?php echo isset($products_info->champion_products_title) ? $products_info->champion_products_title : "NA";?></td>
                            ...
                            <td><a href="<?php echo base_url("admin/shirts/female_edit/".$products_info->Id); ?>"><small class="label bg-red">edit</small></a></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php } else { ?>
