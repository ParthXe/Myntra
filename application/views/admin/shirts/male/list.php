...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Shirts Products List<small><a href="<?php echo base_url("admin/shirts/male_add"); ?>">Add Shirts Products</a></small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Shirts Male Products List</h3>
                  <div class="box-tools">
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="table">
                    <tr>
                     ...
                     <?php if (count($shirts_male) > 0 ){ ?>
                    <?php foreach($shirts_male as $products_info) : ?>
                        <tr>
                            ...
                            <td><a href="<?php echo base_url("admin/shirts/male_edit/".$products_info->Id); ?>"><small class="label bg-red">edit</small></a></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php } else { ?>
