...
$(function() {
    ...
    $('.testimonials_sortable').sortable({
        ...
        update: function(event, ui) {
            ...
            // return false;
            $.ajax({
                url: base_url+"shirts/reorder_trends",
                type: 'POST',
                ...
                <div class="box-body">
                    ...
                    <?php echo form_open('', 'class="form-user-edit" role="form" autocomplete="off" enctype="multipart/form-data"') ; ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($images = $shirt_male['trends_images']){
                                $image = explode(",", $images);
                                for($ii=0;$ii<count($image);$ii++) {
                                echo '<li id='.$ii.'><span></span><img src="'.base_url().'myntra/section_products/pro_shirts/trends_images/'.$image[$ii].'" width="150px"></li>';
                                }
