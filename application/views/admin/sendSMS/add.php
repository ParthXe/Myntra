              ...
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php echo form_open("admin/sendSMS/add/$type", 'class="form-add-edit" role="form" autocomplete="off" enctype="multipart/form-data"') ; ?>
						...
						<div class="form-group">
							<label for="bodyTxt">Body Text:</label>
							<textarea class="form-control" id="bodyTxt" name="bodyTxt" value="" required/></textarea>
						</div>
						<div class="form-group">
							<label for="button1">Button1 Text:</label>
							<input type="text" class="form-control" id="button1" name="button1" value="" required/>
						</div>
						<div class="form-group">
							<label for="button2">Button2 Text:</label>
							<input type="text" class="form-control" id="button2" name="button2" value="" required/>
						</div>
						<div class="row">
							<!-- /.col -->
							<div class="col-xs-3">
