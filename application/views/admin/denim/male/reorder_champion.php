...
$(function() {
	...
	$('.testimonials_sortable').sortable({
        ...
        update: function(event, ui) {
            ...
            // return false;
            $.ajax({
                url: base_url+"denim/reorder_images",
                type: 'POST',
					...
					<?php echo form_open('', 'class="form-user-edit" role="form" autocomplete="off" enctype="multipart/form-data"') ; ?>
						...
						<div class="form-group">
							...
							<?php if($images = $denim_male['champion_products_images']){
								...
								echo '<li id='.$ii.'><span></span><img src="'.base_url().'myntra/section_products/pro_denims/champion_product_images/'.$image[$ii].'" width="150px"></li>';
								}
