            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Denim Male Products List</h3>
                  <div class="box-tools">
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="table">
                    ...
                    <?php if (count($denim_male) > 0 ){ ?>
                    <?php foreach($denim_male as $products_info) : ?>
                        <tr>
                            ...
                            <td><a href="<?php echo base_url("admin/denim/male_edit/".$products_info->Id); ?>"><small class="label bg-red">edit</small></a></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php } else { ?>
