...
$(function() {
	...
	$('.testimonials_sortable').sortable({
        ...
        update: function(event, ui) {
            ...
            // return false;
            $.ajax({
                url: base_url+"tshirts/reorder_images",
                type: 'POST',
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Change details for Tshirts <?php echo $tshirt_male['champion_products_title'] ;?></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
					<?php if (isset($error)) : ?>
					...
					<?php echo form_open('', 'class="form-user-edit" role="form" autocomplete="off" enctype="multipart/form-data"') ; ?>
						...
						<div class="form-group">
							...
							<?php if($images = $tshirt_male['champion_products_images']){
								$image = explode(",", $images);
								for($ii=0;$ii<count($image);$ii++) {
								echo '<li id='.$ii.'><span></span><img src="'.base_url().'myntra/section_products/pro_tshirts/champion_product_images/'.$image[$ii].'" width="150px"></li>';
								}
