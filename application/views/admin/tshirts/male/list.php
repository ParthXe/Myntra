...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tshirts Products List<small><a href="<?php echo base_url("admin/tshirts/male_add"); ?>">Tshirts Products</a></small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tshirt Male Products List</h3>
                  <div class="box-tools">
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="table">
                   ...
                   <?php if (count($tshirts_male) > 0 ){ ?>  
                    <?php foreach($tshirts_male as $products_info) : ?>
                        <tr>
                           <td><?php echo isset($products_info->champion_products_title) ? $products_info->champion_products_title : "NA";?></td>
                            ...
                            <td><a href="<?php echo base_url("admin/tshirts/male_edit/".$products_info->Id); ?>"><small class="label bg-red">edit</small></a></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php } else { ?>
