            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Add T-shirt</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
					<?php if (isset($error)) : ?>
					...
					<?php echo form_open('', 'class="form-add-edit" role="form" autocomplete="off" enctype="multipart/form-data"') ; ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="championsProductsTitle1" name="champions_products_title1" placeholder="Champions Products Title" autocomplete="off" value="" required>
						</div>
						<div class="form-group">
