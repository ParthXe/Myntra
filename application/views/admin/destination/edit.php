                ...
                <div class="box-body">
					...
					<?php echo form_open('', 'class="form-user-edit" role="form" autocomplete="off"') ; ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="destinationState" name="destination_state" placeholder="Destination State" autocomplete="off" value="<?php echo $destination['destination_state']; ?>" required>
						</div>
						<div class="form-group">
							<label for="userEditMail">Destination Description</label>
							<textarea class="form-control" id="destinationDesc" name="destination_desc" placeholder="Destination Description" required><?php echo $destination['destination_desc']; ?></textarea>
						</div>
						<div class="form-group">
							<label for="userEditFname">Why Go There</label>
							<input type="text" class="form-control" id="WhyGoThere" name="why_go" placeholder="Why Go There" value="<?php echo $destination['why_go_there']; ?>" required>
						</div>
						<div class="form-group">
							<label for="userEditLname">How Far</label>
							<input type="text" class="form-control" id="HowFar" name="how_far" placeholder="How Far" value="<?php echo $destination['how_far']; ?>" required>
						</div>
						<div class="form-group">
