...
if($type == "outlander")
{
	...
	$xml_output .= "<jsonProdLooks><![CDATA[http://192.168.1.42/myntra/admin/looksJSON]]></jsonProdLooks>\n";
	...
	$xml_output .= "\t\t<insttext posX='300' posY='1400' width='650' height='400'>".$collectionvideoinfo['insttext']."</insttext>\n";
