...
<<<<<<< HEAD
	...
	$xml_output .= "\t\t<exploreBtnPath posX='300' posY='1400'><![CDATA[".$asset_path."screensaver/".$screensaverinfo['exploreBtnPath']."]]></exploreBtnPath>\n";
	$xml_output .= "</screensaver>\n";
	$xml_output .= "<collectionVideo>\n";
	$xml_output .= "\t\t<bgPath posX='0' posY='0' transparency='.9'><![CDATA[".$asset_path."collectionvideo/".$collectionvideoinfo['bgPath']."]]></bgPath>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='10'><![CDATA[".$asset_path."collectionvideo/".$collectionvideoinfo['homebuttonImage']."]]></homebuttonImage>\n";
	...
	$xml_output .= "\t\t<BackbuttonImage posX='40' posY='20'><![CDATA[".$asset_path."roadsterselection/".$roadsterselectioninfo['BackbuttonImage']."]]></BackbuttonImage>\n";
	...
	$xml_output .= "\t\t<BackbuttonImage posX='40' posY='20'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['BackbuttonImage']."]]></BackbuttonImage>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='10'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['homebuttonImage']."]]></homebuttonImage>\n";
	$xml_output .= "\t\t<sortBtnImage posX='0' posY='109'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['sortBtnImage']."]]></sortBtnImage>\n";
	$xml_output .= "\t\t<sortRollBtnImage posX='0' posY='109'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['sortRollBtnImage']."]]></sortRollBtnImage>\n";
	$xml_output .= "\t\t<filterBtnImage posX='542' posY='109'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['filterBtnImage']."]]></filterBtnImage>\n";
	$xml_output .= "\t\t<filterRollBtnImage posX='542' posY='109'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['filterRollBtnImage']."]]></filterRollBtnImage>\n";
	$xml_output .= "\t\t<myntralogoImage posX='440' posY='20'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['myntralogoImage']."]]></myntralogoImage>\n";
	$xml_output .= "\t\t<blackbgImage posX='0' posY='109'><![CDATA[".$asset_path."listvideo/".$listvideoinfo['blackbgImage']."]]></blackbgImage>\n";
...
=======
	...
	$xml_output .= "</screensaver>\n";
	$xml_output .= "<collectionVideo>\n";
	$xml_output .= "\t\t<bgPath posX='30' posY='80' transparency='.9'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['bgPath']."]]></bgPath>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='70'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['homebuttonImage']."]]></homebuttonImage>\n";
	$xml_output .= "\t\t<scrtext posX='300' posY='270' width='50' height='400'><![CDATA[".$type."/".$collectionvideoinfo['scrtext']."]]></scrtext>\n";
	$xml_output .= "\t\t<insttext posX='100' posY='1400' width='950' height='400'><![CDATA[".$type."/".$collectionvideoinfo['insttext']."]]></insttext>\n";
	...
	$xml_output .= "\t\t<BackbuttonImage posX='40' posY='70'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['BackbuttonImage']."]]></BackbuttonImage>\n";
	...
	$xml_output .= "\t\t<BackbuttonImage posX='40' posY='70'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['BackbuttonImage']."]]></BackbuttonImage>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='70'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['homebuttonImage']."]]></homebuttonImage>\n";
	$xml_output .= "\t\t<sortBtnImage posX='0' posY='214'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['sortBtnImage']."]]></sortBtnImage>\n";
	$xml_output .= "\t\t<sortRollBtnImage posX='0' posY='214'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['sortRollBtnImage']."]]></sortRollBtnImage>\n";
	$xml_output .= "\t\t<filterBtnImage posX='542' posY='214'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['filterBtnImage']."]]></filterBtnImage>\n";
	$xml_output .= "\t\t<filterRollBtnImage posX='542' posY='214'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['filterRollBtnImage']."]]></filterRollBtnImage>\n";
	...
	$xml_output .= "\t\t<blackbgImage posX='0' posY='200'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['blackbgImage']."]]></blackbgImage>\n";
...
>>>>>>> bfc9413dd0fe2eabc222156843da158a046511a8
	$xml_output .= "\t\t<sortList>\n"; 
...
<<<<<<< HEAD
	...
	$xml_output .= "\t\t<BackbuttonImage posX='40' posY='20'><![CDATA[".$asset_path."productdesc/".$productdescinfo['BackbuttonImage']."]]></BackbuttonImage>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='10'><![CDATA[".$asset_path."productdesc/".$productdescinfo['homebuttonImage']."]]></homebuttonImage>\n";
...
=======
	...
	$xml_output .= "\t\t<BackbuttonImage posX='40' posY='70'><![CDATA[".$asset_path."productdesc/".$type."/".$productdescinfo['BackbuttonImage']."]]></BackbuttonImage>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='70'><![CDATA[".$asset_path."productdesc/".$type."/".$productdescinfo['homebuttonImage']."]]></homebuttonImage>\n";
...
<<<<<<< HEAD
	$xml_output .= "\t\t<nextbuttonImage posX='940' posY='1000'><![CDATA[".$asset_path."productdesc/".$productdescinfo['nextbuttonImage']."]]></nextbuttonImage>\n";
...
=======
	$xml_output .= "\t\t<nextbuttonImage posX='1040' posY='1000'><![CDATA[".$asset_path."productdesc/".$type."/".$productdescinfo['nextbuttonImage']."]]></nextbuttonImage>\n";
