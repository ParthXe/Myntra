...
if($type == "outlander")
{
	...
	$xml_output .= "<jsonProdLooks><![CDATA[http://localhost/myntra/admin/looksJSON]]></jsonProdLooks>\n";
	...
	$xml_output .= "\t\t<collectionMenImage posX='0' posY='360'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['collectionMenImage']."]]></collectionMenImage>\n";
	$xml_output .= "\t\t<catalogueMenImage posX='444' posY='1100'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['catalogueMenImage']."]]></catalogueMenImage>\n";
	$xml_output .= "\t\t<collectionWomenImage posX='0' posY='360'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['collectionWomenImage']."]]></collectionWomenImage>\n";
	$xml_output .= "\t\t<catalogueWomenImage posX='444' posY='1100'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['catalogueWomenImage']."]]></catalogueWomenImage>\n";
	$xml_output .= "\t\t<collectionHeadingTxt posX='60' posY='310'><![CDATA[".$roadsterselectioninfo['collectionHeadingTxt']."]]></collectionHeadingTxt>\n";
	$xml_output .= "\t\t<collectionTxt posX='650' posY='500'><![CDATA[".$roadsterselectioninfo['collectionTxt']."]]></collectionTxt>\n";
	$xml_output .= "\t\t<collectionBtnImage posX='580' posY='680'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['collectionBtnImage']."]]></collectionBtnImage>\n";
...
else if($type == "motogp")
{
	...
	$xml_output .= "\t\t<bgPath posX='0' posY='0' transparency='.9'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['bgPath']."]]></bgPath>\n";
	$xml_output .= "\t\t<homebuttonImage posX='940' posY='10'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['homebuttonImage']."]]></homebuttonImage>\n";
	$xml_output .= "\t\t<scrtext posX='300' posY='200' width='550' height='670'><![CDATA[".$collectionvideoinfo['scrtext']."]]></scrtext>\n";
	$xml_output .= "\t\t<insttext posX='300' posY='1400' width='650' height='400'><![CDATA[".$collectionvideoinfo['insttext']."]]></insttext>\n";
	$xml_output .= "\t\t<motoGpvideo posX='150' posY='750' width='800' height='600'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['motoGpvideo']."]]></motoGpvideo>\n";
	$xml_output .= "\t\t<outLandervideo posX='150' posY='750' width='800' height='600'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['outLandervideo']."]]></outLandervideo>\n";
	$xml_output .= "\t\t<buttonImage posX='270' posY='1600'><![CDATA[".$asset_path."collectionvideo/".$type."/".$collectionvideoinfo['buttonImage']."]]></buttonImage>\n";
	...
	$xml_output .= "\t\t<collectionWomenImage posX='0' posY='360'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['collectionWomenImage']."]]></collectionWomenImage>\n";
	$xml_output .= "\t\t<catalogueWomenImage posX='444' posY='1100'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['catalogueWomenImage']."]]></catalogueWomenImage>\n";
	$xml_output .= "\t\t<collectionHeadingTxt posX='650' posY='430'><![CDATA[".$roadsterselectioninfo['collectionHeadingTxt']."]]></collectionHeadingTxt>\n";
	$xml_output .= "\t\t<collectionTxt posX='650' posY='500'><![CDATA[".$roadsterselectioninfo['collectionTxt']."]]></collectionTxt>\n";
	$xml_output .= "\t\t<collectionBtnImage posX='630' posY='680'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['collectionBtnImage']."]]></collectionBtnImage>\n";
	$xml_output .= "\t\t<catalogueHeadingTxt posX='50' posY='1200'><![CDATA[".$roadsterselectioninfo['catalogueHeadingTxt']."]]></catalogueHeadingTxt>\n";
	$xml_output .= "\t\t<catalogueTxt posX='50' posY='1280'><![CDATA[".$roadsterselectioninfo['catalogueTxt']."]]></catalogueTxt>\n";
	$xml_output .= "\t\t<catalogueBtnImage posX='50' posY='1490'><![CDATA[".$asset_path."roadsterselection/".$type."/".$roadsterselectioninfo['catalogueBtnImage']."]]></catalogueBtnImage>\n";
	$xml_output .= "</roadSterSlection>\n";
	$xml_output .= "<listVidew>\n";
	$xml_output .= "\t\t<topBarImage posX='0' posY='0'><![CDATA[".$asset_path."listvideo/".$type."/".$listvideoinfo['topBarImage']."]]></topBarImage>\n";
	$xml_output .= "\t\t<headingTxt posX='150' posY='20'><![CDATA[".$listvideoinfo['headingTxt']."]]></headingTxt>\n";
